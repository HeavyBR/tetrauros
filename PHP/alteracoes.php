		...
		$formSenha = "<form action = 'alteracoes.php' method = 'POST'>
				...
				if (isset($_POST["nome_completo"]) && isset($_POST["novo_nome"]))
				{
					try
					{
						...
						$SQL = "UPDATE usuario SET nome_completo = $novo_nome WHERE username = '$logado'";
						$conn->exec($SQL);
				...
				if (isset($_POST["telefone"]) && isset($_POST["novo_telefone"]))
				{
					try
					{
						...
						$SQL = "UPDATE usuario SET telefone = $novo_telefone WHERE username = '$logado'";
						$conn->exec($SQL);
				...
				if (isset($_POST["email"]) && isset($_POST["novo_email"]))
				{
					try
					{
						...
						$SQL = "UPDATE usuario SET email = $novo_email WHERE username = '$logado'";
						$conn->exec($SQL);
				...
				if (isset($_POST["senha"]) && isset($_POST["nova_senha"]))
				{
					try
					{
						...
						$SQL = "UPDATE usuario SET password = $nova_senha WHERE username = '$logado'";
						$conn->exec($SQL);
